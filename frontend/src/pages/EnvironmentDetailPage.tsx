  ...
  return (
    <div className="mx-auto flex h-full max-w-3xl flex-col px-6 py-8">
      <header className="mb-4">
        <Link
          to={backTo}
          className="text-xs text-slate-500 hover:text-ops-primary"
        >
          {resolvedBackLabel}
        </Link>
      ...
      <section>
        ...
        {testResult && (
          <div
            className={
              testResult.ok
                ? 'mb-3 rounded border border-ops-success/30 bg-ops-success-soft px-3 py-2 text-xs text-ops-success'
